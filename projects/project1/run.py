...
def run():
    ...
    x_train, x_test, y_train, train_ids, test_ids, labels = load_csv_data(
    ...
    nan_percentage = (
        1  # Threshold of NaN values in a feature above which the feature is removed
    )
    ...
    w, loss = reg_logistic_regression(
        y_tr_cleaned, tx, lambda_, w_initial, max_iter, gamma
    )
