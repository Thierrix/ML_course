...
def run():
    ...
    x_train_slices, y_train_slices = slice_data(x_train_cleaned, y_train_cleaned, k, seed=2)
    ...
    x_test_cleaned = clean_test_data(
        x_test, labels, features, median_and_most_probable_class, mean_pca, W, degree, mean, std
    )
