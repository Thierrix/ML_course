...
def grid_search_k_fold(y, x, k_fold, lambdas, gammas, up_sampling_percentages, degrees, variances_threshold, max_iters,
    ...
    all_combinations = itertools.product(
        gammas, up_sampling_percentages, degrees, variances_threshold,
        lambdas, max_iters, decision_threshold, acceptable_nan_percentages,
        outliers_row_limit, nan_handlers
    )
    ...
    for gamma, up_sampling_percentage, degree, variance_threshold, lambda_, max_iter, threshold, acceptable_nan_percentage, outlier_limit, nan_handling in all_combinations:
        total_f1_score_te = 0
        ...
        for k in range(k_fold):
            ...
            f1_score_te = cross_validation(
                y, x, k_indices, k, lambda_, up_sampling_percentage, degree, variance_threshold,
                gamma, max_iter, threshold, acceptable_nan_percentage, labels, outlier_limit, nan_handling
            )
